            ...
            <div class="col-md-14">
                <form method="POST" action="questionnaire_process.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <label for="option1" class="radio-inline col-md-4">
                            <input type="radio" id="Yes" name="Relocate" value="Yes">Yes</label>
                            
                            <label for="option2" class="radio-inline col-md-4">
                            <input type="radio" id="No" name="Relocate" value="No">No</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <h5>Question 3</h5>
                        ...
                        <div class="input-group">
                            <label for="option1" class="radio-inline col-md-4">
                            <input type="radio" id="Yes" name="RegularC" value="Yes">Yes</label>
                            
                            <label for="option2" class="radio-inline col-md-4">
                            <input type="radio" id="No" name="RegularC" value="No">No</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <h5>Question 4</h5>
                        <br>
                        <label for="Q4">Do you plan to continue to commute into the District of Columbia?</label>
                        <div class="input-group">
                            <label for="option1" class="radio-inline col-md-4">
                            <input type="radio" id="Yes" name="ContinueC" value="Yes">Yes</label>
                            
                            <label for="option2" class="radio-inline col-md-4">
                            <input type="radio" id="No" name="ContinueC" value="No">No</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <h5>Question 5</h5>
                        ...
                        <div class="input-group">
                            <label for="option1" class="radio-inline col-md-4">
                            <input type="radio" id="Yes" name="WorkedS" value="Yes">Yes</label>
                            
                            <label for="option2" class="radio-inline col-md-4">
                            <input type="radio" id="No" name="WorkedS" value="No">No</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <h5>Question 6</h5>
                        ...
                        <div class="input-group">
                            <label for="option1" class="radio-inline col-md-4">
                            <input type="radio" id="Yes" name="DeniedJ" value="Yes">Yes</label>
                            
                            <label for="option2" class="radio-inline col-md-4">
                            <input type="radio" id="No" name="DeniedJ" value="No">No</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <h5>Question 7</h5>
                        <br>
                        <label for="Q7">Answer "Yes" if any of these statements apply to you:</label>
                        <br>
                        <div class="input-group">
                            <ul>
                        ...
                        <div class="input-group">
                            <label for="option1" class="radio-inline col-md-4">
                            <input type="radio" id="option1" name="MultipleQ" value="Yes">Yes</label>
                            
                            <label for="option2" class="radio-inline col-md-4">
                            <input type="radio" id="option2" name="MultipleQ" value="No">No</label>
                        </div>
                    </div>    
                    <br>
                    <br>
