...
//A: PULLING OUT SPECIFIC NUMBER OF CHARACTERS OUT OF STRING 
    ...
    $query = "INSERT INTO applicants(soc_sec_id, first_name, last_name, dob, address, city, state, city, zip, pass, pass2 )";
    VALUES('$social', '$fname','$lname','$email', '$dob', '$address', '$city', '$state', )
    }
}
?>